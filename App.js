...
const resList = [
	...
	},
	{
		info: {
			id: "567661",
			name: "The Oven",
			cloudinaryImageId: "zygmai7jr1yfhphxzjdz",
			locality: "AZAD MOHAL, THANA SADAR CANTT",
			areaName: "AZAD MOHAL, THANA SADAR CANTT",
			costForTwo: "₹200 for two",
		...
		cta: {
			link: "https://www.swiggy.com/restaurants/the-oven-azad-mohal-thana-sadar-cantt-lucknow-567661",
			text: "RESTAURANT_MENU",
			type: "WEBLINK",
		},
		widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	},
	{
		info: {
			...
			cloudinaryImageId: "hrbalqyelw9frir1wh73",
			areaName: "Charbagh",
			costForTwo: "₹200 for two",
		...
		cta: {
			link: "https://www.swiggy.com/restaurants/shere-punjab-hotel-charbagh-lucknow-143158",
			text: "RESTAURANT_MENU",
			type: "WEBLINK",
		},
		widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	},
	{
		info: {
			...
			availability: {
				nextCloseTime: "2024-08-26 10:00:00",
				opened: true,
			},
			badges: {
				imageBadges: [
	...
	},
	{
		info: {
			id: "95777",
			name: "Punjabi Dhaba",
			cloudinaryImageId: "kpdeqh6kvpvdqdats2ns",
			locality: "Charbagh",
			areaName: "Charbagh",
			costForTwo: "₹200 for two",
			cuisines: ["Biryani", "Indian", "Thalis"],
			avgRating: 3.9,
			parentId: "1476",
			avgRatingString: "3.9",
			totalRatingsString: "10K+",
		...
		cta: {
			link: "https://www.swiggy.com/restaurants/punjabi-dhaba-charbagh-lucknow-95777",
			text: "RESTAURANT_MENU",
			type: "WEBLINK",
		},
		widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	},
	{
		info: {
			id: "73053",
			name: "Shree Mithai Mahal",
			cloudinaryImageId: "e274f4109b5780c282e3075941b1ca5a",
			areaName: "Sadar Bazaar",
		...
		cta: {
			link: "https://www.swiggy.com/restaurants/shree-mithai-mahal-sadar-bazaar-lucknow-73053",
			text: "RESTAURANT_MENU",
			type: "WEBLINK",
		},
		widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	},
	{
		info: {
			...
			areaName: "Alambagh",
			costForTwo: "₹200 for two",
			cuisines: ["Indian", "Chinese", "Thalis", "Street Food"],
			avgRating: 4.3,
			veg: true,
			parentId: "12121",
			avgRatingString: "4.3",
		...
		cta: {
			link: "https://www.swiggy.com/restaurants/shri-balaji-dhaba-alambagh-lucknow-132663",
			text: "RESTAURANT_MENU",
			type: "WEBLINK",
		},
		widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
	...
	return (
		<div className="footer">
			<div className="footer-content">
				...
				<p>
					{" "}
					We are a team of technologists who are passionate about technology and
